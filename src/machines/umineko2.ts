...
const referencePoints = [
  ...
  },
  {
    ...
    body:
      ...
      'キャラクターボイスが発生し内容で設定を示唆する(プロトタイプ注記: 出典1件のみで未クロス検証)。' +
      'レバーオンする前にPUSHボタンを押すと何度でも聞き直せる。\n\n' +
      '・秀吉「悪魔や！悪魔の仕業や！」→ デフォルト\n' +
      '・南條「残念だが、手の施しようがない…」→ 奇数設定示唆\n' +
      '・金蔵「おぉ～！！ベアトリーチェぇ～！！」→ 奇数設定示唆\n' +
      '・夏妃「もう…私を…許してッ…！」→ 偶数設定示唆\n' +
      '・楼座「私は何て、馬鹿なママだったの…！！」→ 偶数設定示唆\n' +
      '・縁寿「ここはあなたのいるべき世界じゃないわ」→ 設定2以上\n' +
      '・ベアトリーチェ「あっひゃははははっ！！」→ 設定5以上\n\n' +
      '他にも、ステージチェンジ時のロゴ発光(小=奇数設定示唆、大=偶数設定示唆)がある。',
  },
  {
    title: 'ボーナス終了画面',
    body:
      '終了画面のパターンで設定を示唆する。「戦人一家」以降の高設定示唆パターンはBB終了画面でのみ' +
      '出現する(2サイトでクロス確認済み)。\n\n' +
      '・都会(昼背景) → 基本パターン\n' +
      '・縁寿ダイブ(夜背景+縁寿) → 設定変更濃厚\n' +
      '・屋敷の正面玄関(ベアト見下ろし) → 設定上げ濃厚\n' +
      '・戦人一家 → 設定2以上濃厚\n' +
      '・ベアト・戦人① → 設定2・4・6濃厚\n' +
      '・ベアト・戦人② → 設定4以上濃厚\n' +
      '・ベアト・GM戦人① → 設定5以上濃厚\n' +
